                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="pengeluaran_update.php" method="POST" enctype="multipart/form-data">
                                                            <div class="modal-body">
                                                                <?php
                                                                $id = $d['id_pengeluaran'];
                                                                $sqledit = mysqli_query($koneksi, "SELECT * FROM pengeluaran INNER JOIN kategori ON pengeluaran.kode_kegiatan = kategori.kode_kegiatan WHERE pengeluaran.id_pengeluaran = '$id'");
                                                                while ($rowe = mysqli_fetch_assoc($sqledit)) {
                                                                ?>
                                                                    <input type="hidden" name="id_pengeluaran" value="<?= $rowe['id_pengeluaran'] ?>">
                                                                    <input type="hidden" name="kode_kegiatan" value="<?= $rowe['kode_kegiatan'] ?>">

                                                                    <div class="form-group" style="width:100%">
                                                                        <label>Tanggal</label>
                                                                        <input type="date" name="tanggal" style="width:100%" required="required" class="form-control" placeholder="Tanggal .." value="<?php echo $rowe['tanggal']; ?>">
                                                                    </div>

                                                                    <div class="form-group" style="width:100%">
                                                                        <label>Kegiatan</label>
                                                                        <input type="text" name="kategori" required="required" class="form-control" placeholder="No. Bukti.." value="<?php echo $rowe['kategori']; ?>" style="width:100%" readonly>
                                                                    </div>


                                                                    <div class="form-group" style="width:100%">
                                                                        <label>No. Bukti</label>
                                                                        <input type="text" name="no_bukti" required="required" class="form-control" placeholder="No. Bukti.." value="<?php echo $rowe['no_bukti']; ?>" style="width:100%" readonly>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group" style="width:100%">
                                                                        ...
                                                                        <input type="text" id="uraian" name="uraian" value="<?php echo $rowe['uraian']; ?>" style="width:100%" class="form-control">
                                                                    </div>

                                                                    <div class="form-group" style="width:100%">
                                                                        <label for="pengeluaran">Pengeluaran</label>
                                                                        <input type="number" id="pengeluaran" value="<?php echo $rowe['pengeluaran']; ?>" name="pengeluaran" style="width:100%" class="form-control">
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group" style="width:100%">
                                                                        ...
                                                                        <input type="text" id="pajak1" value="<?php echo $rowe['pajak1']; ?>" name="pajak1" style="width:100%" class="form-control">
                                                                    </div>
