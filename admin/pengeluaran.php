                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="pengeluaran_update.php" method="POST" enctype="multipart/form-data">
                                                            <div class="modal-body">
                                                                ...
                                                                <input type="hidden" name="id_pengeluaran" value="<?= $d['id_pengeluaran'] ?>">
                                                                <input type="hidden" name="kode_kegiatan" value="<?= $d['kode_kegiatan'] ?>">
                                                                ...
                                                                <div class="form-group" style="width:100%">
                                                                    ...
                                                                    <input type="text" name="kategori" required="required" class="form-control" placeholder="No. Bukti.." value="<?php echo $d['kategori']; ?>" style="width:100%" readonly>
                                                                </div>
                                                                ...
                                                                <div class="form-group" style="width:100%">
                                                                    ...
                                                                    <select name="tanggung_jawab" class="form-control" style="width:100%">
                                                                        <option value="">--Pilih--</option>
                                                                        <?php
                                                                        $tampil = mysqli_query($koneksi, "SELECT * FROM karyawan order by nama_pegawai");
                                                                        while ($row = mysqli_fetch_assoc($tampil)) {
                                                                            if ($row['nama_pegawai'] == $d['tanggung_jawab']) {
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="tanggung_jawab" class="form-control">
                                ...
                                $sql = $koneksi->query("select * from karyawan order by nama_pegawai");
                                while ($data = $sql->fetch_assoc()) {
