    ...
    <section class="content">
        <div class="row">
            <section class="col-lg-12">
                ...
                <div class="box box-info">
                    <div class="box-header">
                        <h3 class="box-title">Laporan Rekap Pendapatan</h3>
                    </div>
                    <div class="box-body">
                        ...
                        ?>
                            ...
                            <a href="cetak/laporan_rekap_pemasukan.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp PRINT</a>
