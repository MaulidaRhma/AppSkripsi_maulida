                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        ?>
                            ...
                            <a href="cetak/laporan_hutang.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp PRINT</a>
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $no = 1;
                                        if ("semua") {
                                            $data = mysqli_query($koneksi, "SELECT * FROM hutang where date(hutang_tanggal)>='$tgl_dari' and date(hutang_tanggal)<='$tgl_sampai'");
                                        } else {
                                            $data = mysqli_query($koneksi, "SELECT * FROM piutang where date(hutang_tanggal)>='$tgl_dari' and date(hutang_tanggal)<='$tgl_sampai'");
                                        }
