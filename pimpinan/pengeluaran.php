                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group" style="width:100%">
                                                                        ...
                                                                        <input type="hidden" name="berkas" required="required" class="form-control" placeholder="Nama Pegawai .." value="<?php echo $d['berkas']; ?>">

                                                                        <select class="form-control form-control-lg" id="exampleFormControlSelect2" name="status" style="width:100%">
                                                                            <option>-- Pilih --</option>
