    ...
    <section class="content">
        <div class="row">
            <section class="col-lg-12">
                ...
                <div class="box box-info">
                    <div class="box-header">
                        <h3 class="box-title">Laporan Pemasukan</h3>
                    </div>
                    <div class="box-body">
                        ...
                        ?>
                            ...
                            <a href="cetak/laporan_pemasukan.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>&kategori=<?php echo $kategori ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp PRINT</a>
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $total_pengeluaran = 0;
                                        if ($kategori == "semua") {
                                            $data = mysqli_query($koneksi, "SELECT * FROM transaksi,kategori where transaksi_jenis='Pemasukan' AND kategori_id=transaksi_kategori and date(transaksi_tanggal)>='$tgl_dari' and date(transaksi_tanggal)<='$tgl_sampai'");
                                        } else {
                                            $data = mysqli_query($koneksi, "SELECT * FROM transaksi,kategori where transaksi_jenis='Pemasukan' AND kategori_id=transaksi_kategori and kategori_id='$kategori' and date(transaksi_tanggal)>='$tgl_dari' and date(transaksi_tanggal)<='$tgl_sampai'");
                                        }
